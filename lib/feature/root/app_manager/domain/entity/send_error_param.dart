...
Future<ErrorParam> createErrorParam({
  ...
  final String networkState = isConnected ? "online" : "offline";
  ...
  return ErrorParam(
    ...
    deviceSystemVersion: deviceInfoService.deviceSystemVersion,
    devicePlatform: deviceInfoService.devicePlatform,
    deviceSdkInt: deviceInfoService.deviceSdkInt.toString(),
    screenPixelRatio: deviceInfoService.screenPixelRatio.toString(),
    screenHeight: deviceInfoService.screenHeight.toString(),
    screenWidth: deviceInfoService.screenWidth.toString(),
    networkStatus: networkState,
    response: response,
    appVersion: AppStrings.appVersion,
    requestPath: requestPath,
    requestMethod: requestMethod,
    appLanguage: locator.get<LanguageStorage>().getCurrentLang() ?? 'ar',
    applicationName: AppStrings.appName,
    token: '', // يمكنك إضافة التوكن هنا إذا لزم الأمر
  );
}
// Future<ErrorParam> createErrorParam({
//   required String message,
